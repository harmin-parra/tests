...
public class WebForm extends PageObject {
    ...
    public void setLogin(String var) {
        find(WebForm.login).sendKeys(var);
    }

    public void setPassword(String var) {
        find(WebForm.password).sendKeys(var);
    }

    public void setTextarea(String var) {
        find(WebForm.textarea).sendKeys(var);
    }

    public void setNumber(int var) {
        find(WebForm.number).selectByIndex(var);
    }

    public void setCity(String var) {
        find(WebForm.city).sendKeys(var);
    }
    ...
    public void setColor(String var) {
        find(WebForm.color).sendKeys(var);
    }

    public void setDate(String var) {
        find(WebForm.date).sendKeys(var);
